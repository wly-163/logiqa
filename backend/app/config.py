...
class Settings(BaseSettings):
    ...
    # ---------- MySQL ----------
    DATABASE_URL: str = (
        "mysql+aiomysql://logiqa:logiqa123456@localhost:3307/logiqa?charset=utf8mb4"
    )
    MYSQL_HOST: str = "localhost"
    MYSQL_PORT: int = 3307
    MYSQL_USER: str = "logiqa"
    MYSQL_PASSWORD: str = "logiqa123456"
    MYSQL_DATABASE: str = "logiqa"

    # ---------- MinIO ----------
    MINIO_ENDPOINT: str = "localhost:9000"
    MINIO_ACCESS_KEY: str = "minioadmin"
    MINIO_SECRET_KEY: str = "minioadmin"
    MINIO_BUCKET: str = "logiqa-documents"
    ...
    MILVUS_COLLECTION: str = "logiqa_chunks"
    ...
    RRF_SPARSE_WEIGHT: float = 1.0        # BM25 稀疏路权重（仓储物流术语精确匹配可调高）
    ...
    MILVUS_COLLECTION_BGE: str = "logiqa_chunks_bge"   # 本地 bge 向量库(独立 collection, 向量空间不混)
    ...
    HIGH_RISK_KEYWORDS: str = "危险品,危化品,冷链断链,高空,登高,叉车,AGV,混装,无单出库,口头指令,超载,带电作业"
    ...
    NACOS_DATA_ID: str = "logiqa.properties"
    ...
    OTEL_SERVICE_NAME: str = "logiqa-backend"  # OTel service.name 标识
    ...
    # ---------- N3 数字孪生仓储园区 3D ----------
    TWIN_LAYOUT_PATH: str = "app/data/warehouse_layout.json"  # 仓储园区布局模板路径
