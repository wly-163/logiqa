...
async def create_ticket(
    db: AsyncSession, *,
    ticket_type: str = "作业单", task: str = "", device: str = "",
    ...
    ticket = Ticket(
        ...
        title=task[:200] if task else "作业单",
        task=task,
        device=device,
        location=location,
...
def _ticket_to_dict(t: Ticket) -> dict:
    return {
        ...
        "ticketType": t.ticket_type.value if t.ticket_type else "作业单",
