...
_EQUIPMENT_TERMS = (
    "WMS", "TMS", "OMS", "AGV", "ASRS", "AMR", "叉车", "月台", "货架", "巷道",
    "冷链探头", "温控探头", "输送线", "分拣机", "托盘", "立体库", "充电桩",
    "拣选工位", "复核台", "打包台", "危险品库", "冷链库", "RDC", "CDC", "FDC",
)
_METRIC_TERMS = (
    "温度", "湿度", "库存", "可售库存", "安全库存", "时效", "准确率", "破损率",
    "准时率", "履约率", "周转率", "利用率", "缺货率", "差异率", "签收率",
    "SLA", "POD", "时间", "距离", "重量", "体积",
)
_GENERIC_SECTIONS = {
