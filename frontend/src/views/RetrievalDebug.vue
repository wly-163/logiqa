  ...
  <div style="padding: 20px;">
    ...
    <div class="card">
      ...
      <div class="field">
        ...
        <textarea class="input" v-model="query" rows="2" placeholder="如：一盘货跨仓调拨库存不足怎么处理" @keydown.ctrl.enter="run"></textarea>
      </div>
      <div class="row" style="align-items: flex-end">
        ...
        <div class="field grow" style="margin-bottom:0">
          ...
          <input class="input" v-model="equipment" placeholder="如：AGV / 冷链库" />
        </div>
