      ...
      <div class="modal governance-modal profile-modal" role="dialog" aria-modal="true" aria-labelledby="profile-title">
        ...
        <form v-else class="modal-scroll profile-form" @submit.prevent="submitProfile">
          ...
          <fieldset>
            ...
            <div class="form-grid">
              <label class="field"><span class="field-label">责任人</span><input v-model.trim="profileForm.owner" class="input" maxlength="64" placeholder="例如：仓配一班 / 张工" /></label>
              <label class="field"><span class="field-label">适用区域</span><input v-model.trim="profileForm.applicableRegion" class="input" maxlength="256" placeholder="例如：华东RDC 冷链库区" /></label>
            </div>
          </fieldset>
