  ...
  <div class="kg-page">
    ...
    <div class="card" v-show="tab === 'graph'">
      <div class="row" style="margin-bottom: 12px">
        <input class="input" v-model="entity" placeholder="🔍 输入实体(如：自动导引车)过滤" @keyup.enter="searchGraph" style="flex:1;min-width:200px" />
    ...
    <div class="card" v-show="tab === 'path'">
      <div class="row" style="margin-bottom: 12px">
        <input class="input" v-model="pathEntity" placeholder="🔍 起点实体(如：立体库/冷链温区)" @keyup.enter="searchPaths" style="flex:1;min-width:200px" />
      ...
      <p class="hint">💡 多跳推理：沿「异常→处置→关联」因果链追溯影响范围（Neo4j）</p>
