...
// ===== N3 数字孪生 =====
export const getStationLayout = (stationId = 'rdc-east-demo') => request.get('/twin/station/layout', { params: { stationId } })
export const getStationOverview = (stationId = 'rdc-east-demo') => request.get('/twin/station/overview', { params: { stationId } })
